<template>
  <footer 
    class="bg-primary-100 dark:bg-primary-800 py-12"
    v-motion
    ...
    <div class="container-custom">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div 
          ...
          :visibleOnce="{ opacity: 1, x: 0, transition: { delay: 200, duration: 600 } }"
        >
          <h3 
            class="text-2xl font-serif mb-4 transform transition-colors duration-300 hover:text-accent-600 cursor-default"
          >
            LENS<span class="text-accent-600">CRAFT</span>
          </h3>
          <p 
            class="mb-4 max-w-md transition-colors duration-300 hover:text-primary-700 dark:hover:text-primary-200"
          >
        ...
        >
          <h4 class="font-serif text-lg mb-4">Quick Links</h4>
          <ul class="space-y-2">
            <li>
              <NuxtLink 
                to="/about" 
      ...
      <div 
        class="border-t border-primary-200 dark:border-primary-700 mt-8 pt-8 text-center text-sm"
        v-motion
        :initial="{ opacity: 0 }"
